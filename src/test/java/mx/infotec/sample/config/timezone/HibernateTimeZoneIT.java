package mx.infotec.sample.config.timezone;
...
import mx.infotec.sample.repository.timezone.DateTimeWrapper;
import mx.infotec.sample.repository.timezone.DateTimeWrapperRepository;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM core_date_time_wrapper where id=%d", fieldName, id);
    }
