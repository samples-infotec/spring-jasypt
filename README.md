...
Rev: [Spring Boot Configuration with Jasypt](https://www.baeldung.com/spring-boot-jasypt)
...
To build the final jar and optimize the angularSample application for production, run:
